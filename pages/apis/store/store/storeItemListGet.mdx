---
title: storeItemListGet
---

import MasterChip from "components/Masterchip/MasterChip.js"

# <MasterChip value={"GET"} /> storeItemListGet
...
Try this API, [Click here](https://web.neome.ai/api?path=store_store_storeItemListGet)
