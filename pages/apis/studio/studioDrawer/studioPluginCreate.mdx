---
title: studioPluginCreate
---

import MasterChip from "components/Masterchip/MasterChip.js"

# <MasterChip value={"POST"} /> studioPluginCreate
...
Try this API, [Click here](https://web.neome.ai/api?path=studio_studioDrawer_studioPluginCreate)
